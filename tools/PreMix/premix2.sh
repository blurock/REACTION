...
OBJS = driv.o premix.o cklib.o tranlib.o twopnt.o math.o -lf2c -lm
...
chem.exe : ckinterp.o
	   g77 -o chem.exe ckinterp.o

tran.exe : tranfit.o cklib.o polfit.o xerror.o -lf2c -lm
	    g77 -o tran.exe tranfit.o cklib.o polfit.o xerror.o -lf2c -lm

premix.exe : driv.o premix.o cklib.o tranlib.o twopnt.o math.o
	   g77 -o premix.exe driv.o premix.o cklib.o tranlib.o twopnt.o math.o -lf2c -lm
