...
CC  R1MACH    sets the unit roundoff of the machine.
...
CC Note..  SVNORM, R1MACH, LUNSAV, and MFLGSV are function routines.
...
C      REAL FUNCTION R1MACH (IDUM)
C      INTEGER IDUM
CC-----------------------------------------------------------------------
CC This routine computes the unit roundoff of the machine.
CC This is defined as the smallest positive machine number
CC u such that  1.0 + u .ne. 1.0
CC
CC Subroutines/functions called by R1MACH.. None
CC-----------------------------------------------------------------------
C      REAL U, COMP
C      U = 1.0
C 10   U = U*0.5
C      COMP = 1.0 + U
C      IF (COMP .NE. 1.0) GO TO 10
C      R1MACH = U*2.0
C      RETURN
C      END
CC----------------------- End of Function R1MACH ------------------------
