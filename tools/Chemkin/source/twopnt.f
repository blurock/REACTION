...
C
C     THIS IS VERSION 2.22D OF FEBRUARY 1994.
C
...
C
C     1) INSERT CHANGE BLOCK PROVIDING INTEGER*8 FOR ASSIGNED GO TO
C        VARIABLES AS NEEDED BY SOME COMPILERS SUCH AS DEC ALPHA.
C        THESE APPARENTLY ARE MACHINES WITH FULL, 64 BIT ADDRESSING.
C
C     2) CORRECT SUBROUTINE CPUTIM TO DECLARE TEMP REAL.
C
C///////////////////////////////////////////////////////////////////////
C
...
99999 CONTINUE
     ...
     +   N, REDUCE, REPORT, RETIRE, STEPS, STMAX, TEXT
C*****assigned go to > integer
      INTEGER RETURN, ROUTE
C*****END assigned go to > integer
C*****assigned go to > integer*8
C      INTEGER*8 RETURN, ROUTE
C*****END assigned go to > integer*8
      LOGICAL
...
0100  CONTINUE
     ...
     +   PLIMIT, PMAX, PMIN, POINTS, STRICT, TEXT, TOTAL, VARY, VARY1,
     +   VARY2
C*****assigned go to > integer
      INTEGER ROUTE
C*****END assigned go to > integer
...
99999 CONTINUE
     ...
     +   NUMBER, REPORT, RETIRE, STEP, STMAX, TDAGE, TEXT, TRIALS,
     +   TRMAX, XREPOR
C*****assigned go to > integer
      INTEGER ROUTE
C*****END assigned go to > integer
...
10002 FORMAT (I3, ':', I2, ':', I2)
     ...
     +   JACOBS, K, LAST, LENGTH, LEVEL, PASS, PASSES, PLIMIT, PMAX,
     +   POINTS, REPORT, RSIZE, SCALRS, SIZE, SSAGE, STEP, STEPS,
     +   STEPS0, STEPS1, STEPS2, STMAX, TDAGE, TEXT, XREPOR
C*****assigned go to > integer
      INTEGER LABEL, RETURN, ROUTE
C*****END assigned go to > integer
C*****assigned go to > integer*8
C      INTEGER*8 LABEL, RETURN, ROUTE
C*****END assigned go to > integer*8
      LOGICAL
...
C///  PRINT THE BANNER AT ALL PRINT LEVELS.
      ...
      BANNER(2) =
     +   'VERSION 2.22D OF FEBRUARY 1994 BY DR. JOSEPH F. GRCAR.'
C*****precision > double
...
C*****COMPUTING TIME > HP-UX
C$NOSTANDARD SYSTEM
C      REAL TEMP
C      TEMP = SECNDS(0.0)
C*****END COMPUTING TIME > HP-UX
