...
Read /home/reaction/cvs/Reaction/data/initialize/StandardExpressionsClass.inp /home/reaction/cvs/Reaction/data/initialize/StandardExpressions.inp 0
END
EOF

Flame.exe xxx Initial cluster -1 < program.prg
